...
# AROS
ifeq ($(PLATFORM),aros)
	SDL_CONFIG = /home/kla/arosbuilds/core-linux-x86_64-d/bin/linux-x86_64/AROS/Development/lib/pkgconfig/sdl2.pc
	CPPFLAGS += --sysroot=/home/kla/arosbuilds/core-linux-x86_64-d/bin/linux-x86_64/AROS/Development -DCPU_x86_64=1 -D_FILE_OFFSET_BITS=64 -UUSE_LIBSERIALPORT -UUSE_OPENGL -I/home/kla/arosbuilds/core-linux-x86_64-d/bin/linux-x86_64/AROS/Development/include
	CFLAGS += -fomit-frame-pointer -Wno-unused -Wno-format -fno-strict-aliasing
	SDL_CFLAGS := -I/home/kla/arosbuilds/core-linux-x86_64-d/bin/linux-x86_64/AROS/Development/include/SDL2 -I/home/kla/arosbuilds/amiberry_3rd/3rd/include/
	SDL_LDFLAGS := -lSDL2
	LDFLAGS = $(SDL_LDFLAGS) -lSDL2_image -lSDL2_ttf -lguisan -Lexternal/libguisan/lib -lmt32emu -Lexternal/mt32emu
	LDFLAGS += -L/home/kla/arosbuilds/core-linux-x86_64-d/bin/linux-x86_64/AROS/Development/lib -L/home/kla/arosbuilds/amiberry_3rd/3rd/lib -Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed -lpthread -lz -lpng -lFLAC -lmpg123 -lmpeg2 -lmpeg2convert -lguichan -lguichan_sdl -lGL -liconv -logg -lnet -no-pie
