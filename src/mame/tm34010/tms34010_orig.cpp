...
tms340x0_device::tms340x0_device (const machine_config & mconfig,
				  device_type type, const char *name,
				  const char *tag, device_t *owner,
				  UINT32 clock, const char *shortname):
...
tms34010_device::tms34010_device (const machine_config & mconfig,
				  const char *tag, device_t *owner,
				  UINT32 clock):
...
tms34020_device::tms34020_device (const machine_config & mconfig,
				  const char *tag, device_t *owner,
				  UINT32 clock):
...
inline void
tms340x0_device::SET_ST (UINT32 st)
{
  m_st = st;
...
inline INT32
tms340x0_device::PARAM_LONG ()
{
  UINT32 pc = TOBYTE (m_pc);
  m_pc += 4 << 3;
  return (UINT16) m_direct->read_raw_word (pc) | (m_direct->
						  read_raw_word (pc +
								 2) << 16);
}
...
inline INT32
tms340x0_device::PARAM_LONG_NO_INC ()
{
  UINT32 pc = TOBYTE (m_pc);
  return (UINT16) m_direct->read_raw_word (pc) | (m_direct->
						  read_raw_word (pc +
...
/* read memory byte */
inline UINT32
tms340x0_device::RBYTE (offs_t offset)
{
  UINT32 ret;
  RFIELDMAC_8 ();
  return ret;
...
/* write memory byte */
inline void
tms340x0_device::WBYTE (offs_t offset, UINT32 data)
{
  WFIELDMAC_8 ();
}
...
/* read memory long */
inline UINT32
tms340x0_device::RLONG (offs_t offset)
{
  RFIELDMAC_32 ();
}
...
/* write memory long */
inline void
tms340x0_device::WLONG (offs_t offset, UINT32 data)
{
  WFIELDMAC_32 ();
}
...
inline void
tms340x0_device::PUSH (UINT32 data)
{
  SP () -= 0x20;
  WLONG (SP (), data);
}
...
inline UINT32
tms340x0_device::do_plane_masking (UINT32 r, UINT32 w)
{
...
UINT32
tms340x0_device::read_pixel_1 (offs_t offset)
{
RP (0x0f, 0x01)}

UINT32
tms340x0_device::read_pixel_2 (offs_t offset)
{
RP (0x0e, 0x03)}

UINT32
tms340x0_device::read_pixel_4 (offs_t offset)
{
RP (0x0c, 0x0f)}

UINT32
tms340x0_device::read_pixel_8 (offs_t offset)
{
RP (0x08, 0xff)}

UINT32
tms340x0_device::read_pixel_16 (offs_t offset)
{
  return TMS34010_RDMEM_WORD (TOBYTE (offset & 0xfffffff0));
}

UINT32
tms340x0_device::read_pixel_32 (offs_t offset)
{
...
/* Shift register read */
UINT32
tms340x0_device::read_pixel_shiftreg (offs_t offset)
{
...
/* No Raster Op + No Transparency */
void
tms340x0_device::write_pixel_1 (offs_t offset, UINT32 data)
{
  WP (0x0f, 0x01);
}

void
tms340x0_device::write_pixel_2 (offs_t offset, UINT32 data)
{
  WP (0x0e, 0x03);
}

void
tms340x0_device::write_pixel_4 (offs_t offset, UINT32 data)
{
  WP (0x0c, 0x0f);
}

void
tms340x0_device::write_pixel_8 (offs_t offset, UINT32 data)
{
  WP (0x08, 0xff);
}

void
tms340x0_device::write_pixel_16 (offs_t offset, UINT32 data)
{
  TMS34010_WRMEM_WORD_MASK (TOBYTE (offset & 0xfffffff0), data);
}

void
tms340x0_device::write_pixel_32 (offs_t offset, UINT32 data)
{
...
/* No Raster Op + Transparency */
void
tms340x0_device::write_pixel_t_1 (offs_t offset, UINT32 data)
{
  WP_T (0x0f, 0x01);
}

void
tms340x0_device::write_pixel_t_2 (offs_t offset, UINT32 data)
{
  WP_T (0x0e, 0x03);
}

void
tms340x0_device::write_pixel_t_4 (offs_t offset, UINT32 data)
{
  WP_T (0x0c, 0x0f);
}

void
tms340x0_device::write_pixel_t_8 (offs_t offset, UINT32 data)
{
  WP_T (0x08, 0xff);
}

void
tms340x0_device::write_pixel_t_16 (offs_t offset, UINT32 data)
{
  if (data)
    TMS34010_WRMEM_WORD_MASK (TOBYTE (offset & 0xfffffff0), data);
}
...
void
tms340x0_device::write_pixel_t_32 (offs_t offset, UINT32 data)
{
  if (data)
...
/* Raster Op + No Transparency */
void
tms340x0_device::write_pixel_r_1 (offs_t offset, UINT32 data)
{
  WP_R (0x0f, 0x01);
}

void
tms340x0_device::write_pixel_r_2 (offs_t offset, UINT32 data)
{
  WP_R (0x0e, 0x03);
}

void
tms340x0_device::write_pixel_r_4 (offs_t offset, UINT32 data)
{
  WP_R (0x0c, 0x0f);
}

void
tms340x0_device::write_pixel_r_8 (offs_t offset, UINT32 data)
{
  WP_R (0x08, 0xff);
}

void
tms340x0_device::write_pixel_r_16 (offs_t offset, UINT32 data)
{
  UINT32 a = TOBYTE (offset & 0xfffffff0);
  TMS34010_WRMEM_WORD_MASK (a,
			    (this->*m_raster_op) (data,
						  TMS34010_RDMEM_WORD_MASK
						  (a)));
}

void
tms340x0_device::write_pixel_r_32 (offs_t offset, UINT32 data)
{
  UINT32 a = TOBYTE (offset & 0xffffffe0);
  TMS34010_WRMEM_DWORD_MASK (a,
			     (this->*m_raster_op) (data,
						   TMS34010_RDMEM_DWORD_MASK
						   (a)));
}

/* Raster Op + Transparency */
void
tms340x0_device::write_pixel_r_t_1 (offs_t offset, UINT32 data)
{
  WP_R_T (0x0f, 0x01);
}

void
tms340x0_device::write_pixel_r_t_2 (offs_t offset, UINT32 data)
{
  WP_R_T (0x0e, 0x03);
}

void
tms340x0_device::write_pixel_r_t_4 (offs_t offset, UINT32 data)
{
  WP_R_T (0x0c, 0x0f);
}

void
tms340x0_device::write_pixel_r_t_8 (offs_t offset, UINT32 data)
{
  WP_R_T (0x08, 0xff);
}

void
tms340x0_device::write_pixel_r_t_16 (offs_t offset, UINT32 data)
{
  UINT32 a = TOBYTE (offset & 0xfffffff0);
...
void
tms340x0_device::write_pixel_r_t_32 (offs_t offset, UINT32 data)
{
  UINT32 a = TOBYTE (offset & 0xffffffe0);
...
void
tms340x0_device::write_pixel_shiftreg (offs_t offset, UINT32 data)
{
...
/* Raster operations */
UINT32
tms340x0_device::raster_op_1 (UINT32 newpix, UINT32 oldpix)
{
  return newpix & oldpix;
}

UINT32
tms340x0_device::raster_op_2 (UINT32 newpix, UINT32 oldpix)
{
  return newpix & ~oldpix;
}

UINT32
tms340x0_device::raster_op_3 (UINT32 newpix, UINT32 oldpix)
{
  return 0;
}

UINT32
tms340x0_device::raster_op_4 (UINT32 newpix, UINT32 oldpix)
{
  return newpix | ~oldpix;
}

UINT32
tms340x0_device::raster_op_5 (UINT32 newpix, UINT32 oldpix)
{
  return ~(newpix ^ oldpix);
}

UINT32
tms340x0_device::raster_op_6 (UINT32 newpix, UINT32 oldpix)
{
  return ~oldpix;
}

UINT32
tms340x0_device::raster_op_7 (UINT32 newpix, UINT32 oldpix)
{
  return ~(newpix | oldpix);
}

UINT32
tms340x0_device::raster_op_8 (UINT32 newpix, UINT32 oldpix)
{
  return newpix | oldpix;
}

UINT32
tms340x0_device::raster_op_9 (UINT32 newpix, UINT32 oldpix)
{
  return oldpix;
}

UINT32
tms340x0_device::raster_op_10 (UINT32 newpix, UINT32 oldpix)
{
  return newpix ^ oldpix;
}

UINT32
tms340x0_device::raster_op_11 (UINT32 newpix, UINT32 oldpix)
{
  return ~newpix & oldpix;
}

UINT32
tms340x0_device::raster_op_12 (UINT32 newpix, UINT32 oldpix)
{
  return 0xffff;
}

UINT32
tms340x0_device::raster_op_13 (UINT32 newpix, UINT32 oldpix)
{
  return ~newpix | oldpix;
}

UINT32
tms340x0_device::raster_op_14 (UINT32 newpix, UINT32 oldpix)
{
  return ~(newpix & oldpix);
}

UINT32
tms340x0_device::raster_op_15 (UINT32 newpix, UINT32 oldpix)
{
  return ~newpix;
}

UINT32
tms340x0_device::raster_op_16 (UINT32 newpix, UINT32 oldpix)
{
  return newpix + oldpix;
}

UINT32
tms340x0_device::raster_op_17 (UINT32 newpix, UINT32 oldpix)
{
...
UINT32
tms340x0_device::raster_op_18 (UINT32 newpix, UINT32 oldpix)
{
  return oldpix - newpix;
}

UINT32
tms340x0_device::raster_op_19 (UINT32 newpix, UINT32 oldpix)
{
  return (oldpix > newpix) ? oldpix - newpix : 0;
}

UINT32
tms340x0_device::raster_op_20 (UINT32 newpix, UINT32 oldpix)
{
  return (oldpix > newpix) ? oldpix : newpix;
}

UINT32
tms340x0_device::raster_op_21 (UINT32 newpix, UINT32 oldpix)
{
...
void
tms340x0_device::check_interrupt ()
{
  int vector = 0;
  int irqline = -1;
  int irq;
...
/* set up the state table */
  {
    ...
    for (int regnum = 0; regnum < 15; regnum++)
      {
	state_add (TMS34010_A0 + regnum,
		   strformat (tempstr, "A%d", regnum).c_str (),
		   m_regs[regnum].reg);
      }
    for (int regnum = 0; regnum < 15; regnum++)
      {
	state_add (TMS34010_B0 + regnum,
		   strformat (tempstr, "B%d", regnum).c_str (),
		   m_regs[30 - regnum].reg);
      }
  }
...
/* allocate a scanline timer and set it to go off at the start */
  m_scantimer =
    ...
    timer_alloc (timer_expired_delegate
		 (FUNC (tms340x0_device::scanline_callback), this));
  ...
  machine ().save ().
    register_postload (save_prepost_delegate
		       (FUNC (tms340x0_device::tms34010_state_postload),
			this));
...
void
tms340x0_device::execute_set_input (int inputnum, int state)
{
...
const
  tms340x0_device::pixel_write_func
  tms340x0_device::s_pixel_write_ops[4][6] = {
  {&tms340x0_device::write_pixel_1, &tms340x0_device::write_pixel_2,
   &tms340x0_device::write_pixel_4, &tms340x0_device::write_pixel_8,
   &tms340x0_device::write_pixel_16, &tms340x0_device::write_pixel_32},
  {&tms340x0_device::write_pixel_r_1, &tms340x0_device::write_pixel_r_2,
   &tms340x0_device::write_pixel_r_4, &tms340x0_device::write_pixel_r_8,
   &tms340x0_device::write_pixel_r_16, &tms340x0_device::write_pixel_r_32},
  {&tms340x0_device::write_pixel_t_1, &tms340x0_device::write_pixel_t_2,
   &tms340x0_device::write_pixel_t_4, &tms340x0_device::write_pixel_t_8,
   &tms340x0_device::write_pixel_t_16, &tms340x0_device::write_pixel_t_32},
  {&tms340x0_device::write_pixel_r_t_1, &tms340x0_device::write_pixel_r_t_2,
   &tms340x0_device::write_pixel_r_t_4, &tms340x0_device::write_pixel_r_t_8,
   &tms340x0_device::write_pixel_r_t_16, &tms340x0_device::write_pixel_r_t_32}
};

const
  tms340x0_device::pixel_read_func
  tms340x0_device::s_pixel_read_ops[6] = {
  &tms340x0_device::read_pixel_1, &tms340x0_device::read_pixel_2,
    &tms340x0_device::read_pixel_4, &tms340x0_device::read_pixel_8,
    &tms340x0_device::read_pixel_16, &tms340x0_device::read_pixel_32
};


void
tms340x0_device::set_pixel_function ()
{
  UINT32 i1, i2;
...
const
  tms340x0_device::raster_op_func
  tms340x0_device::s_raster_ops[32] = {
  NULL, &tms340x0_device::raster_op_1, &tms340x0_device::raster_op_2,
    &tms340x0_device::raster_op_3,
  &tms340x0_device::raster_op_4, &tms340x0_device::raster_op_5,
    &tms340x0_device::raster_op_6, &tms340x0_device::raster_op_7,
  &tms340x0_device::raster_op_8, &tms340x0_device::raster_op_9,
    &tms340x0_device::raster_op_10, &tms340x0_device::raster_op_11,
  &tms340x0_device::raster_op_12, &tms340x0_device::raster_op_13,
    &tms340x0_device::raster_op_14, &tms340x0_device::raster_op_15,
  &tms340x0_device::raster_op_16, &tms340x0_device::raster_op_17,
    &tms340x0_device::raster_op_18, &tms340x0_device::raster_op_19,
      ...
      if (master)		// && (!m_scanline_ind16_cb.isnull() || !m_scanline_rgb32_cb.isnull()))
	{
	  ...
	  if (htotal > 0 && vtotal > 0)
	      ...
	      else
		{
	      ...
	      if (visarea.min_x < visarea.max_x && visarea.max_x <= width
		  && visarea.min_y < visarea.max_y && visarea.max_y <= height)
		{
		  ...
		  if (width != current_width || height != current_height
		      || visarea.min_y != current_visarea.min_y
		      || visarea.max_y != current_visarea.max_y
		      || (m_hblank_stable > 2
			  && (visarea.min_x != current_visarea.min_x
			      || visarea.max_x != current_visarea.max_x)))
		    {
	      ...
	      if ((SMART_IOREG (DPYCTL) & 0x4000) == 0)
		fatalerror
		  ("Interlaced video configured on the TMS34010 (unsupported)\n");
#endif
	    }
	}
    }
...
/* force a partial update within the visible area */
  if (vcount >= current_visarea.min_y && vcount <= current_visarea.max_y
      && (!m_scanline_ind16_cb.isnull () || !m_scanline_rgb32_cb.isnull ()))
...
/* 34010 increments by the DUDATE field in DPYCTL */
      if (!m_is_34020)
	{
	  ...
	  if ((dpyadr & 3) == 0)
	    dpyadr =
	      ((dpyadr & 0xfffc) -
	       (IOREG (REG_DPYCTL) & 0x03fc)) | (IOREG (REG_DPYSTRT) &
						 0x0003);
	  else
...
/* 34020 updates based on the DINC register, including zoom */
	...
	{
	  UINT32 dpynx =
	    IOREG (REG020_DPYNXL) | (IOREG (REG020_DPYNXH) << 16);
...
/* but helps ensure that masters are updated first before slaves */
  m_scantimer->adjust (m_screen->time_until_pos (vcount) +
		       attotime (0, !master), vcount);
#endif
  return vcount;
}

void
tms340x0_device::get_display_params (tms34010_display_params *params)
{
...
/* 34010 gets its address from DPYADR and DPYTAP */
  if (!m_is_34020)
	...
	dpyadr ^= 0xfffc;
      ...
      params->coladdr =
	((dpyadr & 0x007c) << 4) | (IOREG (REG_DPYTAP) & 0x3fff);
...
/* 34020 gets its address from DPYNX */
	...
	params->yoffset =
	  (IOREG (REG020_DPYNXL) & 0x1f) / (IOREG (REG020_DINCL) & 0x1f);
    }
}

#if 0
UINT32
tms340x0_device::tms340x0_ind16 (screen_device & screen,
				 bitmap_ind16 & bitmap,
...
#endif
#if 0
  UINT32 tms340x0_device::tms340x0_rgb32 (screen_device & screen,
					  bitmap_rgb32 & bitmap,
					  const rectangle & cliprect)
  {
	...
	if (mem_mask & 0xff00)
	  {
	    ...
	    if ((data & 0x8000) && !m_external_host_access)
	      m_icount = 0;
#if 0
	    set_input_line (INPUT_LINE_HALT,
			    (data & 0x8000) ? ASSERT_LINE : CLEAR_LINE);
#endif
		...
		machine ().scheduler ().
		  synchronize (timer_expired_delegate
			       (FUNC
				(tms340x0_device::
				 internal_interrupt_callback), this), 0);
#endif
	      }
	  }
	break;
...
//      logerror("%s: %s = %04X (%d)\n", machine().describe_context(), ioreg020_name[offset], IOREG(offset), m_screen.vpos());
...
#if 0
	if (data)
	  logerror ("Plane masking not supported. PC=%08X\n",
	...
	if (data & 0x0100)
	  machine ().scheduler ().
	    synchronize (timer_expired_delegate
			 (FUNC (tms340x0_device::internal_interrupt_callback),
			  this), 0);
	break;
#endif
	...
	if (!(IOREG (REG_HSTCTLH) & 0x2000))
	  {
	    ...
	    m_prefetch_data =
	      TMS34010_RDMEM_WORD (TOBYTE (addr & 0xfffffff0));
	  }
	break;
...
/* control register */
      case TMS34010_HOST_CONTROL:
	{
	  ...
	  if (mem_mask & 0xff00)
	    io_register_w (*m_program, REG_HSTCTLH, data & 0xff00, 0xff00);
	  if (mem_mask & 0x00ff)
	    io_register_w (*m_program, REG_HSTCTLL, data & 0x00ff, 0x00ff);
	  m_external_host_access = FALSE;
	  break;
	}
...
/* control register */
      case TMS34010_HOST_CONTROL:
	result =
	  (IOREG (REG_HSTCTLH) & 0xff00) | (IOREG (REG_HSTCTLL) & 0x00ff);
	break;
...
/* error case */
...
#if 0
  void tms340x0_device::state_string_export (const device_state_entry & entry,
					     std::string & str)
  {
    switch (entry.index ())
      {
  ...
  offs_t tms34010_device::disasm_disassemble (char *buffer, offs_t pc,
					      const UINT8 * oprom,
					      const UINT8 * opram,
					      UINT32 options)
  {
    ...
    return CPU_DISASSEMBLE_NAME (tms34010) (this, buffer, pc, oprom, opram,
					    options);
  }


  offs_t tms34020_device::disasm_disassemble (char *buffer, offs_t pc,
					      const UINT8 * oprom,
					      const UINT8 * opram,
					      UINT32 options)
  {
    ...
    return CPU_DISASSEMBLE_NAME (tms34020) (this, buffer, pc, oprom, opram,
					    options);
  }
#endif
